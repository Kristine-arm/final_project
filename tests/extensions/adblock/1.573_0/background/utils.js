...
function getBrowserStoreUrl() {
    switch (getBrowserId()) {
        case browsers.Edge:
            return 'https://microsoftedge.microsoft.com/addons/detail/fair-adblocker/jccfboncbdccgbgcbhickioeailgpkgb';
        default:
            return 'https://chromewebstore.google.com/detail/adblocker-stands/lgblnfidahcdcjddiepkckcfdhpknnjh';
    }
}
