...
stndz.resources = {
    ...
    blockingRules: 'https://static.standsapp.org/lists/blocking-rules',
    cssRules: 'https://static.standsapp.org/lists/css-rules',
    popupRules: 'https://static.standsapp.org/lists/popup-rules',
    jsRules: 'https://static.standsapp.org/lists/js-rules',
    whitelist: 'https://static.standsapp.org/lists/whitelist',
    user: 'https://prod.standsapp.org/user',
    deactivatedSites: 'https://prod.standsapp.org/user/deactivatedsites/[USERID]',
    reportStats: 'https://prod.standsapp.org/user/stats/hourly',
    geo: 'https://prod.standsapp.org/geolookup',
    detectionSites: 'https://static.standsapp.org/lists/detection-sites',
    detectionSettings: 'https://static.standsapp.org/lists/detection-settings',
    setReadNotification: 'https://prod.standsapp.org/user/notification/[USERID]/[ID]',
    transition: 'https://prod.standsapp.org/trans-rate',
    easyList: 'https://static.standsapp.org/lists/easylist',
    easyListUrl: 'https://static.standsapp.org/lists/easylist-urls',
    notifications: 'https://prod.standsapp.org/user/notifications/',
};
    ...
    window.heartbeatInterval = setTimeout(function() {
        ...
        function sendReloadEvent(data) {
            try {
                ...
                (new Image()).src = 'https://prod.standsapp.org/log3.gif?data=[' + encodeURIComponent(JSON.stringify(obj)) + ']';
            } catch (e) {}
        }
