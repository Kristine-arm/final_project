...
var updatingDataFromServer = function(settings) {
    ...
    function loadDataInterval() {
        console.log('-loadDataInterval-', dataName);
        let shouldLoadData = false;

        getStorageValue(dataDateStorageKey, function(dateExists, date) {
            console.log('-getStorageValue-', dataName, dateExists, date);
            if (dateExists) {
                shouldLoadData =
            ...
            console.log('-shouldLoadData-', dataName, shouldLoadData);
            if (shouldLoadData) {
                loadData();
            }
        });        
    ...
    function loadData() {
        ...
        callUrl({
            ...
            setSingleStorageValue(dataNameStorageKey, data, function(success) {
                if (success) {
                    setSingleStorageValue(dataDateStorageKey, new Date().toString());
                }
            });
        });
    }
